...
(function (workflow) {
    var Guid = (function () {
        function Guid(value) {
            if (value) {
                if (Guid.Validate(value)) {
                    this.Value = value;
                } else {
                    throw "Input is not in a recognized format.";
                }
            } else {
        ...
        Guid.Validate = function (value) {
            return value != null && this.Regex.test(value);
        };
        ...
        Guid.Empty = new Guid();
        Guid.Regex = new RegExp("^[0-9a-fA-F]{8}(-[0-9a-fA-F]{4}){3}-[0-9a-fA-F]{12}$");
        return Guid;
    })();
    workflow.Guid = Guid;
    ...
    workflow.GetQueryString = GetQueryString;
